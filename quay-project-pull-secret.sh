...
oc create secret docker-registry quay-cicd-secret --docker-server=quay.io --docker-username="$quayuser" --docker-password="$quaypass" --docker-email=$quayemail -n "$uatproject"
